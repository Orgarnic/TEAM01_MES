...
namespace Cohesion_DTO
{
    public class Work_Order_MST_DTO
    {
		...
		[Category("속성"), Description("PRODUCT_QTY"), DisplayName("생산 수량")]
		public decimal PRODUCT_QTY { get; set; }        //생산 수량
		[Category("속성"), Description("DEFECT_QTY"), DisplayName("불량 수량")]
		public decimal DEFECT_QTY { get; set; }         //불량 수량
		[Category("속성"), Description("WORK_START_TIME"), DisplayName("작업 시작 시간")]
		public DateTime WORK_START_TIME { get; set; }   //작업 시작 시간
		[Category("속성"), Description("WORK_CLOSE_TIME"), DisplayName("지시 마감 시간")]
		public DateTime WORK_CLOSE_TIME { get; set; }   //지시 마감 시간
		[Category("속성"), Description("WORK_CLOSE_USER_ID"), DisplayName("지시 마감자")]
		public string WORK_CLOSE_USER_ID { get; set; }  //지시 마감자
		[Category("속성"), Description("CREATE_TIME"), DisplayName("작업지시 생성 시간")]
		public DateTime CREATE_TIME { get; set; }       //작업지시 생성 시간
		[Category("속성"), Description("CREATE_USER_ID"), DisplayName("작업지시 생성 사용자")]
		public string CREATE_USER_ID { get; set; }      //작업지시 생성 사용자
		[Category("속성"), Description("UPDATE_TIME"), DisplayName("작업지시 변경 시간")]
		public DateTime UPDATE_TIME { get; set; }       //작업지시 변경 시간
		[Category("속성"), Description("UPDATE_USER_ID"), DisplayName("작업지시 변경 사용자")]
